        ...
        <tr>
          <td style="padding: 32px;">
            ...
            <p style="margin: 0 0 24px; font-size: 15px; line-height: 1.6; color: #3f3f46;">
              Thanks for trying out <strong>nuxt-email</strong>. This message was rendered
              from a Vue template on the server.
            </p>
            <a
              v-if="verifyUrl"
              :href="verifyUrl"
              style="display: inline-block; padding: 12px 20px; background-color: #18181b; color: #ffffff; font-size: 14px; text-decoration: none; border-radius: 6px;"
            >
              Verify your email
            </a>
          </td>
